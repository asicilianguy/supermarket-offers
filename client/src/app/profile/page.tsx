...
export default function Profile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast.success("Supermercati aggiornati con successo")
      ...
      const errorMessage = err.data?.message || "Errore durante l'aggiornamento"
  ...
  const handleLogout = () => {
    ...
    showToast.info("Logout effettuato con successo")
    router.push("/login")
  }
  ...
  if (isError) {
    showToast.error("Errore nel caricamento del profilo")
    router.push("/login")
    return null
  }
